...
async function createWizardTestScenario2(dataSource: DataSource): Promise<void> {
  ...
  await orgRepo.save({
    ...
    trade_name: 'Wizard Tech',
    tax_identification_number: 'TAX-123456789',
    country_of_incorporation: 'US',
    date_of_incorporation: new Date('2010-03-15'),
    organization_type: 'corporation',
    industry_sector: 'technology',
    contact_email: 'contact@wizardtech.example.com',
    contact_phone: '+1-555-0200',
    operating_address: '456 Wizard Corporate Blvd, Floor 10, Magic City, CA 90210, US',
    registered_address: '456 Wizard Corporate Blvd, Floor 10, Magic City, CA 90210, US',
